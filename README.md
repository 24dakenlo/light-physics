...
スペクトルは光の現象を記述する非常に一般的な方法であり、これに慣れておく必要がある。例えば、太陽光のスペクトルは以下の通りである（図）。

太陽光が様々な波長の正弦波から構成されていることがわかる。特に、グラフは 400 nm から 700 nm の間にピークを持っている。これは、太陽光のエネルギーの大部分が 400 nm から 700 nm の波長を持つ正弦波から来ていることを意味する。この光のカテゴリは「可視光」と呼ばれている。なぜなら、私たちの目がそれを感知できるからである。同時に、それは多くの地上植物における光合成を活性化させる「光合成有効放射」でもある。


## 光のカテゴリー

先に書いたように、可視光、つまり人間の目が感知できる光の波長は 400 nm から 700 nm の間である。これは太陽光の大部分を占めているが、自然界においては非常に狭く限られたカテゴリである。実際、光の波長はそれよりはるかに短くても長くてもよい。波長が短い順から長い順に、光はガンマ線、X線、紫外線（UV）、可視光、赤外線、マイクロ波などと呼ばれる。これらのカテゴリの間には明確な境界があるわけではない。実際、光の波長は任意に連続的に正の値を取ることができる。それにもかかわらず、波長のスケールが光の特性や振る舞いに非常に強く依存しているため、これらのグループに分類するのは便利である。例えば、光と植物の葉の相互作用は、可視光とマイクロ波の間で非常に異なる。可視光は葉によって大部分が吸収または反射されるが、マイクロ波は葉との相互作用がほとんどないかもしれない。
...
先に述べたように、人間の視覚は「可視光」と呼ばれる波長が約 400 nm から約 700 nm の光によって行われる。人間の目はこの範囲外の光を感知できない。これは、人間の目の錐体がそのような光に反応しないためである。したがって、もし人間とは異なる種類の錐体を持つ動物がいれば、人間には見えない光を見ることができるかもしれない。実際、鳥や一部の昆虫は人間の可視光より波長の短い紫外線（UV）に反応する錐体を持っている。そのため、これらの動物の視覚を研究する際には、私たちにとって見えない光を考慮する必要がある。
...
前のセクションでは光の色について議論した。ここでは物体（オブジェクト）の色について議論する。これらは似ているが異なる概念であり、注意深く区別する必要がある。例えば、植物の緑色の葉を想像してみよう。植物の葉は、ある光源からの光で照らされている。その後、植物の葉はその光を私たちの目に散乱させる。したがって、植物の葉の色は照らしている光の色と、その光が植物の葉によってどのように散乱されるかに依存する。私たちの目に届く反射光は、散乱された光である。色は光の特徴であるため、葉を照らす光源を考慮しない限り、葉の色について議論することはできない。葉の色は、実際には葉によって散乱される光の色に関連して議論される。そして、奇妙なことが起こることがある。もし光が元々赤色で、M錐体（緑の反応を引き起こす）を刺激する光がほとんど含まれていない場合、反射光も赤色になる可能性がある。
