...
So far, we have described and explained light in two ways: photon beam and electromagnetic wave. Although they look very different ideas, they do not conflict with each other. Indeed, light has these two aspects: in some cases, the particle aspect dominates, and in other cases, the wave aspect dominates. For each case, physisists has already discovered a theoretical principle: the quantum dynamics for the particle (photon), and the Maxwell equation for the wave. Learning these two theories needs skills of math and physics beyond a prerequisite for most ecologists. Therefore, we summarize some imporatnt features of these theories without explaining how and why. 
