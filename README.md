...
光には偏光という属性がある。端的に言えばぞれは電場の向きに関する特徴である。既に述べた「性質1: 電場と磁束密度と伝播方向が互いに直交する」を思い出そう。進行方向をz軸とすると, 電場Eの方向はxy平面に平行な面の中にある。つまり, 光が君の目にやってくるとき, 同じ波長・位相・強度だとしても, その光がもたらす電場の向きは, 光のやってくる方向に垂直な面内で様々でありえる。
